...
- (void)viewDidLoad {
    ...
    [_tableview setSelectionColor:[UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0f]];
    [_tableview setTitles:cols
                  WithWeights:weights
                  WithOptions:options
